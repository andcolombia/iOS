...
*/
let kIssuer: String = "https://qaautenticaciondigital.and.gov.co/.well-know/openid-configuration";
...
/**
 ...
 For client configuration instructions, see the [README](https://github.com/openid/AppAuth-iOS/blob/master/Examples/Example-iOS_Swift-Carthage/README.md).
*/
let kRedirectURI: String = "com.agencia.app:/oauth2redirect/example-provider";
